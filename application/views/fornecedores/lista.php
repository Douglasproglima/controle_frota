...
<table class="table table-striped">
      ...
      <tbody>      	
        ...
        <tr>
          ...
          <td>
          	<a href="<?php echo base_url("fornecedores/editar") . "/" . $fornecedor->id;?>">
          ...
          <td>          	
            <a href="<?php echo base_url("fornecedores/excluir") . "/" . $fornecedor->id;?>" title="Excluir" class="btn btn-default button-delete">Apagar</a>
          </td>
        </tr>            
        <?php endforeach; ?>   
      </tbody>
